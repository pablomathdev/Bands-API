...
public class AlbumAPITest {
	...
	static final String UPDATE_ALBUM_ERROR_ALBUM_WITH_NON_EXISTENT_BAND = "classpath:data/update_album_test_error_non-existent_band.json";
	static final String UPDATE_ALBUM_ERROR_ALBUM_WITH_NON_EXISTENT_GENRE = "classpath:data/update_album_test_error_non-existent_genre.json";
	...
	@Test
	public void should_ReturnStatusCode400_WhenBandInAlbumNotFound() throws IOException {

		Resource resource = resourceLoader.getResource(UPDATE_ALBUM_ERROR_ALBUM_WITH_NON_EXISTENT_BAND);
	...
	@Test
	public void should_ReturnStatusCode400_WhenGenreInAlbumNotFound() throws IOException {

		Resource resource = resourceLoader.getResource(UPDATE_ALBUM_ERROR_ALBUM_WITH_NON_EXISTENT_GENRE);
