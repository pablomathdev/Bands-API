...
public class TrackAPITest {
	...
	static final String CREATE_TRACK_SUCCESS = "classpath:data/create_track_test_success.json";
	static final String CREATE_TRACK_ERROR_TRACK_WITH_NON_EXISTENT_BAND = "classpath:data/create_track_test_error_non-existent_band.json";
	static final String CREATE_TRACK_ERROR_TRACK_WITH_NON_EXISTENT_GENRE = "classpath:data/create_track_test_error_non-existent_genre.json";
	...
	@Test
	public void should_ReturnStatusCode400_WhenGenreInTrackNotExists() throws IOException {

		Resource resource = resourceLoader.getResource(CREATE_TRACK_ERROR_TRACK_WITH_NON_EXISTENT_GENRE);
	...
	@Test
	public void should_ReturnStatusCode400_WhenBandInAlbumFromTrackNotExists() throws IOException {

		Resource resource = resourceLoader.getResource(CREATE_TRACK_ERROR_TRACK_WITH_NON_EXISTENT_BAND);
	...
	public void should_ReturnStatusCode204_WhenTrackIsRemoved() {
		...
		given()
		.queryParam("trackTitle", "Enter Sandman")
	...
	@Test
	public void should_ReturnStatusCode404_WhenTrackNotFound() {
		
		given()
		.queryParam("trackTitle", "Sad but True")
		.queryParam("albumTitle", "Metallica")
		.accept(ContentType.JSON)
		.when()
		.delete()
		.then()
