...
import com.github.pablomathdev.infraestructure.mappers.AlbumRequestDTOToAlbum;
...
public class AlbumController {
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<?> update(@PathVariable Integer id,@RequestBody @Valid AlbumRequestDTO albumRequestDTO ){
